...
public class ClienteController {
    ...
    @PutMapping("/{id}")
    @Operation(summary = "Se actualizan datos de un cliente", description = "Se modifica los datos de un cliente y se actualiza en la base de datos")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> getMisPedidos(@PathVariable Long id){
        return ResponseEntity.ok(clienteService.getMisPedidos(id));
    }
    ...
    public ResponseEntity<?> getStatsAnio(@PathVariable Long id, @RequestParam int anio){
        return ResponseEntity.ok(clienteService.getStatsAnio(id, anio));
    }
    ...
    public ResponseEntity<?> getMisBoletas(@PathVariable Long id){
        return ResponseEntity.ok(clienteService.getMisBoletas(id));
    }
    ...
    public ResponseEntity<?> getResumen(
        ...
        return ResponseEntity.ok(clienteService.getResumen(id, anio));
    }
}