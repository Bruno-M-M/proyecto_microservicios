...
public class BoletaConfig implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        boleta1.setClienteRun("20699543-4");
        boleta1.setClienteCorreo("br.matelzsczs@asd.cl");
        boleta1.setClienteDireccion("Calle quinta 666");
        ...
        boleta2.setClienteRun("20699543-4");
        boleta2.setClienteCorreo("br.matelzsczs@asd.cl");
        boleta2.setClienteDireccion("Calle quinta 666");
