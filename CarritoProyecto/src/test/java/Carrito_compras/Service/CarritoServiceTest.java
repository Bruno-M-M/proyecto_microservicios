package Carrito_compras.Service;
...
public class CarritoServiceTest {
    ...
    @Test
    void confirmar_debeRetornarCarritoConfirmado() {
    ...
    @Test
    void cancelar_debeRetornarCarritoCancelado() {
        Carrito carrito = crearCarritoFake();
        carrito.setEstado(Carrito.EstadoPedido.PENDIENTE);
        ...
        var resultado = carritoService.cancelar(carrito.getId());
