    ...
    CommandLineRunner initData(CarritoRepository carritoRepository) {
        return args -> {
            ...
            for (int i = 0; i < 5; i++) {
                ...
                item2.setProductoId((long) faker.number().numberBetween(1, 5));
